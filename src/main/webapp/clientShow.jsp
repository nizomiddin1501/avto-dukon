...
<%--                <div><strong>ID :</strong> <%= userById.getId() %></div>--%>
<%--                <div><strong>Firstname :</strong> <%= userById.getFirstname() %></div>--%>
<%--                <div><strong>Lastname :</strong> <%= userById.getLastname() %></div>--%>
<%--                <div><strong>Email :</strong> <%= userById.getEmail() %></div>--%>
<%--                <div><strong>Password :</strong> <%= userById.getPassword() %></div>--%>
<%--                <div><strong>Phone Number :</strong> <%= userById.getPhone_number() %></div>--%>
<%--                <div><img src="<%= request.getContextPath() %>/<%= userById.getPhoto() %>" alt="Client Photo"></div>--%>
<%--            </div>--%>
