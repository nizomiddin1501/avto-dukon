...
<%--                                     class="img-fluid" alt="Sample image">--%>
                                ...
                                <img src="images/cars/last.jpg" class="img-fluid" alt="Sample image">
                                <img src="images/cars/uff.webp" class="img-fluid" alt="Sample image">
                                ...
                                <form>
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="firstname"
                                               id="exampleInputFirstname" itemid="exampleInputEmail"
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="lastname"
                                               id="exampleInputLastname" itemid="exampleInputLastname"
                                               placeholder="Enter lastname" required>
                                    </div>

                                    <div data-mdb-input-init class="form-outline mb-4">
                                        <label class="form-label" for="exampleInputPhoneNumber">Phone Number</label>
                                        <input type="number" class="form-control form-control-lg" name="phoneNumber"
                                               id="exampleInputPhoneNumber" itemid="exampleInputPhoneNumber"
                                    ...
                                    <div class="text-center text-lg-start mt-4 pt-2">
                                        <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                                ...
                                                style="padding-left: 2.5rem; padding-right: 2.5rem;">SIGN UP
                                        </button>
