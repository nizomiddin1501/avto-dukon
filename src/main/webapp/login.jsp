                            ...
                            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                                <form>
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-3">
                                        ...
                                        <input type="password" class="form-control form-control-lg" name="password" id="exampleInputPassword"   itemid="exampleInputPassword" placeholder="**************" required/>
                                    </div>
                                    ...
                                    <div class="text-center text-lg-start mt-4 pt-2">
                                        ...
                                        <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="registration.jsp?id=" class="link-danger">Register</a></p>
                                    </div>
